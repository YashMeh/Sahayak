...
router.get("/",function(req,res){                   //Find All=> find()  //Make a new one =>create(req.body)  //Find specific=> findById(req.params.id)
	shop.find()										//Updata any query=> findOneAndUpdata({_id:req.params.id},req.body,{new:true})
...
router.get("/:postId",function(req,res){
	shop.findById(req.params.postId)
...
router.put("/:postId",function(req,res){
	shop.findOneAndUpdate({_id:req.params.postId},req.body,{new:true})  //findOneAndUpdate
...
router.delete("/:postId",function(req,res){
	shop.remove({_id:req.params.postId})
